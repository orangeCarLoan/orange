...
<div>
    ...
    <div>
        ...
        <div>
				...
				<input type="hidden" name="contratId" value="<%=request.getParameter("contratId")%>" id="contratId">
                ...
                <table id="tab10" class="table table-striped" style="table-layout: fixed;">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: center">
		                   <textarea id='branchOpinion' name="branchOpinion" style="width:100%;height: 80px;;resize: none;">
		                   </textarea>
                        </td>
                    </tr>
                    </table>
                    ...
                    <tr>
     			    ...
     			    <table id="tab9" class="table table-striped" style="table-layout: fixed;">
	     			    ...
	     			    <tbody id="carTbody">
		                    <tr>
		                        <td>抵押车辆评估表</td>
		                        <td><span id="carAssessList"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
		                    <tr>
		                    	<td>车辆照片</td>
		                    ...
		                    <tr>
		                    	<td>车辆登记证书(原件)</td>
		                        <td><span id="carRegister"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
		                    <tr>
		                        <td>车辆行驶证正副本(原件)</td>
		                        <td><span id="carLicense"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
		                     <tr>
		                        <td>保单(交强险)</td>
		                        <td><span id="gutCompulsory"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
		                    <tr>
		                        <td>保单(商业险)</td>
		                        <td><span id="gutCommercial"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
		                    <tr>
		                        <td>其他车辆附件</td>
		                        <td><span id="otherAttachments"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-default">下载</button></td>
		                        <td></td><td></td>
		                    </tr>
	                    </tbody>
                    </table>
