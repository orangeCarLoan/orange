...
<script type="text/javascript" src="<%=basePath%>js/headCredit.js"></script>
</head>
<body>
<p style="outline: 1px solid black;">车贷管理>总公司审核列表</p>
<div>
       ...
       <table id="tab8" class="table table-striped" style="border: 1px solid black">
                ...
                <table id="tab9" class="table table-striped" style="border: 1px solid black">
                   ...
                   <textarea id='firstComment' style="width:1270px;height: 160px">
                    ...
                    <tr>
                        <td style="width: 250px">总公司初审意见<span style="color: red">*</span></td>
                        <td colspan="3" style="text-align: center">
                   <textarea id='headComment' style="width:1270px;height: 160px">
                   </textarea>
                        </td>
                    </tr>
                    </table>
