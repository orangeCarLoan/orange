...
<body>
	<div style="margin-top: 10px;"><font style="margin-left: 1%">当前位置:车辆信息录入</font></div>
	...
	<div style="margin-top: 20px;margin-left: 1%">
		...
		<button id="apply" type="button" class="btn btn-info">申请信用信息录入</button>
		&nbsp;&nbsp;
...
$("#apply").click(function() {
	if(trId != 0){
		$("#ifrom").load('branchcompany/carInfo.jsp?contractId='+trId);
	}else{
		alert("请选择某一行");
	}
})
