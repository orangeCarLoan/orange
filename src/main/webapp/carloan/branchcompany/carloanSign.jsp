...
<body>
	<div style="margin-top: 10px;">
		<font style="margin-left: 1%">当前位置:车贷签约</font>
	</div>
	...
	<div style="margin-top: 20px; margin-left: 1%">
		...
		<button id="sign" type="button" class="btn btn-info">签约</button>
		&nbsp;&nbsp;
		<button id="backout" type="button" class="btn btn-info">撤销</button>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<h1 class="modal-title" id="myModalLabel">是否撤销该客户？</h1>
					</center>
				</div>
				<div class="modal-footer">
					<center>
						<button id="delete" style="width: 120px;" type="button"
							class="btn btn-info" data-dismiss="modal">确定</button>
						<button style="width: 120px;" type="button" class="btn btn-info"
...
$("#sign").click(function() {
	if(trId != 0){
		$("#ifrom").load('branchcompany/signInfo.jsp?contractId='+trId);
	}else{
		alert("请选择某一行");
	}
})
