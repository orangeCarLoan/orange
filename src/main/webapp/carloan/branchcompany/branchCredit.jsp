...
<body>
<div style="margin-top: 10px;"><font style="margin-left: 1%">当前位置：车贷管理>分公司审核列表</font></div>
<div>
    ...
    <div>
        ...
        <div>
                ...
                <caption class="caption">信用信息</caption>
	                <tr>
						<td>有无房产</td>
						<td><label><input class="noradio" name="houseProperty" value="1" checked="checked" type="radio" id="input1"/>有</label><label><input class="noradio" name="houseProperty" type="radio" value="0" id="input2"/>无</label></td>
						<td>有无房贷</td>
						<td><input class="noradio" name="houseLoan" value="1" checked="checked" type="radio" id="input3"/>有<input class="noradio" name="houseLoan" type="radio" value="0" id="input4"/>无</td>
					</tr>
					<tr>
						<td>有无车产</td>
						<td><input class="noradio" name="carProperty" value="1" checked="checked" type="radio" id="input5"/>有<input class="noradio" name="carProperty" type="radio" value="0" id="input6"/>无</td>
						<td>有无车贷</td>
						<td><input class="noradio" name="carLoan" value="1" checked="checked" type="radio" id="input7"/>有<input class="noradio" name="carLoan" type="radio" value="0" id="input8"/>无</td>
					</tr>
                     <tr>
                        <td>信用卡、贷款最大逾期状况（24个月内）</td>
                        <td><input id="maxSituation" class="noread" name="maxSituation" type="text" /></td>
                        <td>信用卡、贷款最大逾期次数*（24个月内）</td>
                        <td><input id="maxNumber" class="noread" name="maxNumber" type="text" /></td>
                    </tr>
					<tr>
                        <td>信用卡额度使用率</td>
                        <td><input id="creditCardUsageRate" class="noread" name="creditCardUsageRate" type="text" /></td>
                        <td>信用卡、审批查询次数（6个月内）</td>
                        <td><input id="noccLae" class="noread" name="noccLae" type="text" /></td>
                    </tr>
                    <tr>
                        <td>有无其他信用贷款</td>
                        <td><input id="otherCreditLoans" class="noread" name="otherCreditLoans" type="text" /></td>
                        <td>有无信用卡）</td>
                        <td><input id="creditCard" class="noread" name="creditCard" type="text" /></td>
                    </tr>
                </table>
                </form>
                <form id="myform3">
                ...
                <caption class="caption">电话核查列表</caption>
                	...
                	<tbody id="tbody">
                		<tr id="trClass" style="text-align: center;">
                			...
                			<td class="isLoan">
                				<input class="noradio" type="radio"  name="isLoan1" value="1"/>是&nbsp;&nbsp;&nbsp;&nbsp;
                				<input class="noradio" type="radio" checked="checked" name="isLoan1" value="0"/>否
                			</td>
                			<td>
                ...
                <table id="tab10" class="table table-striped" style="table-layout: fixed;">
                    ...
                    <center>
		                ...
		                <button style="width: 150px;" id="getBackClientBase" type="button" class="btn btn-info" >客户基本信息回退</button>
		                <button style="width: 150px;" id="getBackCarInfo" type="button" class="btn btn-info" >车辆信息回退</button>
		            </center>
...
$(".noread").removeAttr("readOnly"); 
$(":radio").attr("onclick","return false;");
$(".noradio").removeAttr("onclick")
